function viewModel() {
    ...
    saveChanges = function() {
        ...
        projectsData[self.projectId()-1].name = $("#projectName").val();
        projectsData[self.projectId()-1].description = $("#description").val();
        projectsData[self.projectId()-1].category = $("#category").val();
        projectsData[self.projectId()-1].comments = $("#comments").val();

        console.log(projectsData[self.projectId()-1]);
